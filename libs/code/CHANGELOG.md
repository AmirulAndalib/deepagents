...
## [0.1.70](https://github.com/AmirulAndalib/deepagents/compare/deepagents-code==0.1.69...deepagents-code==0.1.70) (2026-09-15)
...
* **code:** add `GPT-6 Astra` support ([#6141](https://github.com/AmirulAndalib/deepagents/issues/6141)) ([048f989](https://github.com/AmirulAndalib/deepagents/commit/048f9890bfe8b640e1e72085a4fa50d9084545f0))
...
* **code:** copy model slug with Ctrl+click ([#6243](https://github.com/AmirulAndalib/deepagents/issues/6243)) ([8a5c317](https://github.com/AmirulAndalib/deepagents/commit/8a5c317e45edb0df4ad42ae79c1c5a6f8cff407f))
* **code:** default Auto classifier by provider ([#6039](https://github.com/AmirulAndalib/deepagents/issues/6039)) ([99ed6c8](https://github.com/AmirulAndalib/deepagents/commit/99ed6c83238851eb334e19b27d3faec8869fc9a7))
* **code:** default general-purpose subagents to fork mode ([#6024](https://github.com/AmirulAndalib/deepagents/issues/6024)) ([d3ad134](https://github.com/AmirulAndalib/deepagents/commit/d3ad134a49287d80b9897b0ef38b4635f8d7de94))
...
* **code:** limit thread resume age ([#6068](https://github.com/AmirulAndalib/deepagents/issues/6068)) ([318311f](https://github.com/AmirulAndalib/deepagents/commit/318311f56c3d3b9c4af4ece22fcfc387eeece5cc))
...
* **code:** list DeepSeek V4.1 Flash in picker ([#6254](https://github.com/AmirulAndalib/deepagents/issues/6254)) ([0a93587](https://github.com/AmirulAndalib/deepagents/commit/0a9358749d7654cc0bd9273a9e007be89abf316d))
...
* **code:** recommend GLM 5.3 models ([#6211](https://github.com/AmirulAndalib/deepagents/issues/6211)) ([e7e88d5](https://github.com/AmirulAndalib/deepagents/commit/e7e88d5efaf2bbce33237ea323fb68487eabd721))
...
* **code:** reuse server across workspace switches ([#6152](https://github.com/AmirulAndalib/deepagents/issues/6152)) ([ca2d1ef](https://github.com/AmirulAndalib/deepagents/commit/ca2d1ef7f270d0fa1040e5473f43e99937b5f03f))
...
* **code:** show session length in Debug Console ([#6224](https://github.com/AmirulAndalib/deepagents/issues/6224)) ([05edbb1](https://github.com/AmirulAndalib/deepagents/commit/05edbb14d0855303ce74d42a4bf368804856c43a))
...
* **code:** surface locally tracked GitHub stacks ([#6290](https://github.com/AmirulAndalib/deepagents/issues/6290)) ([c08cae6](https://github.com/AmirulAndalib/deepagents/commit/c08cae693e0036fcd45d979a7dfa3a7e306a0515))
...
* **sdk,code:** update `read_file` output formatting ([#5648](https://github.com/AmirulAndalib/deepagents/issues/5648)) ([276beca](https://github.com/AmirulAndalib/deepagents/commit/276becae1bbaa38d6253aee90e99212e7bdf0606))
...
* **code:** attribute dotenv config sources ([#6222](https://github.com/AmirulAndalib/deepagents/issues/6222)) ([6f1ac85](https://github.com/AmirulAndalib/deepagents/commit/6f1ac85c46604ef093a9d295fbcc52a8108aa8ed))
...
* **code:** bound transcript tail reconciliation ([#6057](https://github.com/AmirulAndalib/deepagents/issues/6057)) ([8da3264](https://github.com/AmirulAndalib/deepagents/commit/8da32644dc7dcad1125a840bc17ec3d5ea66b8c3))
...
* **code:** confirm server restart for workspace switch ([#6178](https://github.com/AmirulAndalib/deepagents/issues/6178)) ([7997203](https://github.com/AmirulAndalib/deepagents/commit/7997203245915aa83e87db83252c04391bd00440))
...
* **code:** demote no-output hint suppression to debug ([#6245](https://github.com/AmirulAndalib/deepagents/issues/6245)) ([d93ab33](https://github.com/AmirulAndalib/deepagents/commit/d93ab3351bbf4c3687212f665094ccad100f2c08))
...
* **code:** drop stale Anthropic thinking blocks ([#6300](https://github.com/AmirulAndalib/deepagents/issues/6300)) ([fe01fac](https://github.com/AmirulAndalib/deepagents/commit/fe01fac1fa3c4d30d9379a9e5f4273a622710049))
...
* **code:** expose unknown reasoning effort ([#6241](https://github.com/AmirulAndalib/deepagents/issues/6241)) ([ed715ee](https://github.com/AmirulAndalib/deepagents/commit/ed715eeba608af47c9ed7943822c25d935a30b9e))
...
* **code:** isolate LangSmith auth and workspace tracing ([#6061](https://github.com/AmirulAndalib/deepagents/issues/6061)) ([794eda8](https://github.com/AmirulAndalib/deepagents/commit/794eda83b777a2a7278e5726607e4b305801298d))
...
* **code:** isolate user shell tracing credentials ([#6242](https://github.com/AmirulAndalib/deepagents/issues/6242)) ([35c21fa](https://github.com/AmirulAndalib/deepagents/commit/35c21faafe329f4f6932c0941d163306e1aa06e5))
...
* **code:** name models in classifier errors ([#6038](https://github.com/AmirulAndalib/deepagents/issues/6038)) ([fff2c77](https://github.com/AmirulAndalib/deepagents/commit/fff2c77c755c6d9dce3a6f776a9b94599ad05cfd))
* **code:** offload server config import ([#6089](https://github.com/AmirulAndalib/deepagents/issues/6089)) ([90fe4f4](https://github.com/AmirulAndalib/deepagents/commit/90fe4f4ac0a1311f1527b1a5cd02bd3ac8664580))
...
* **code:** open debug console at log bottom ([#6218](https://github.com/AmirulAndalib/deepagents/issues/6218)) ([34f1b6b](https://github.com/AmirulAndalib/deepagents/commit/34f1b6b037b24a1f2fe8b1d6112d9f8cdfe32bf2))
* **code:** order debug console log filters ([#6217](https://github.com/AmirulAndalib/deepagents/issues/6217)) ([4bbad10](https://github.com/AmirulAndalib/deepagents/commit/4bbad10385b22cb76dc40aaa4709d4726f20db02))
* **code:** parse extra skill dirs with platform separator ([#6151](https://github.com/AmirulAndalib/deepagents/issues/6151)) ([56e4ef1](https://github.com/AmirulAndalib/deepagents/commit/56e4ef1a5f447950a04ba37a7855c8e0babd2f11))
...
* **code:** price Fireworks GLM-5.3 Flash usage ([#6223](https://github.com/AmirulAndalib/deepagents/issues/6223)) ([d3627ea](https://github.com/AmirulAndalib/deepagents/commit/d3627eaaeda2de62c19b0647ac29f80767057241))
* **code:** price Fireworks GLM-5.3 usage ([#6221](https://github.com/AmirulAndalib/deepagents/issues/6221)) ([07c5d2e](https://github.com/AmirulAndalib/deepagents/commit/07c5d2ecfe5db6238eff782f714fbbe08865e8d4))
* **code:** price nested usage with its own model and honor completions ([#6251](https://github.com/AmirulAndalib/deepagents/issues/6251)) ([f413a40](https://github.com/AmirulAndalib/deepagents/commit/f413a40f7e74ada749b18491aa276ee1224c7368))
...
* **code:** refuse a second sandbox workspace ([#5979](https://github.com/AmirulAndalib/deepagents/issues/5979)) ([cb4c973](https://github.com/AmirulAndalib/deepagents/commit/cb4c973172f7838eefa328ea0c6ca334b6aaab98))
...
* **code:** resolve project policy per workspace ([#6064](https://github.com/AmirulAndalib/deepagents/issues/6064)) ([ea1f253](https://github.com/AmirulAndalib/deepagents/commit/ea1f2536537efb01c71dce54c46894b9318c4f80))
...
* **code:** run sandbox creation and entry off the guarded event loop ([#6017](https://github.com/AmirulAndalib/deepagents/issues/6017)) ([fd28bfb](https://github.com/AmirulAndalib/deepagents/commit/fd28bfb5c5e1ca18af975d8e57d361c1c23f81b7))
...
* **code:** scope project dotenv to workspaces ([#5980](https://github.com/AmirulAndalib/deepagents/issues/5980)) ([678c115](https://github.com/AmirulAndalib/deepagents/commit/678c11559d7534ee5e16ceebfacf01eeb6536ac7))
...
* **code:** serialize transcript tail reconciliation ([#6143](https://github.com/AmirulAndalib/deepagents/issues/6143)) ([5fb8b69](https://github.com/AmirulAndalib/deepagents/commit/5fb8b699843ecf93debc592d9dbb8a534f54db09))
...
* **code:** show the spinner during pre-stream turn setup ([#6253](https://github.com/AmirulAndalib/deepagents/issues/6253)) ([fa609c2](https://github.com/AmirulAndalib/deepagents/commit/fa609c23ba883557d015529d431ae266847e388c))
* **code:** silence absent themes config warning ([#6220](https://github.com/AmirulAndalib/deepagents/issues/6220)) ([b93f748](https://github.com/AmirulAndalib/deepagents/commit/b93f7483bb5722bbae281a19a80a7aea21d38832))
...
* **code:** standardize recent-thread environment variable ([#6205](https://github.com/AmirulAndalib/deepagents/issues/6205)) ([a4c218e](https://github.com/AmirulAndalib/deepagents/commit/a4c218e185bc49a11a381c3afde91f6efa7226fc))
...
* **code:** surface stale updates in-session ([#6063](https://github.com/AmirulAndalib/deepagents/issues/6063)) ([cdb9d4c](https://github.com/AmirulAndalib/deepagents/commit/cdb9d4c30f4419c0eb2c98ad53940875e4dfbe9e))
* **code:** surface the LangSmith credential in `dcode config` ([#6083](https://github.com/AmirulAndalib/deepagents/issues/6083)) ([a1a0887](https://github.com/AmirulAndalib/deepagents/commit/a1a0887f7e42d0f8515ad415c9b9062e89350e8c))
...
* **code:** treat effort changes as cache identity for OpenAI and Anthropic ([#6196](https://github.com/AmirulAndalib/deepagents/issues/6196)) ([cacd50a](https://github.com/AmirulAndalib/deepagents/commit/cacd50adc365e949e4f0b9a7e94ad6f8eeb7d497))
